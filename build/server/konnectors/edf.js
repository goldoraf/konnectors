...
var EDFBill, EDFClient, EDFConsumptionStatement, EDFContract, EDFHome, EDFPaymentTerms, File, Folder, K, _edfRequestPost, _extend, async, buildNotifContent, builder, cozydb, createNewFile, displayData, edfRequestPost, fetchEdeliaElecIndexes, fetchEdeliaGasIndexes, fetchEdeliaMonthlyElecConsumptions, fetchEdeliaMonthlyGasConsumptions, fetchEdeliaProfile, fetchEdeliaSimilarHomeYearlyElecComparisions, fetchEdeliaSimilarHomeYearlyGasComparisions, fetchEdeliaToken, fetchListerContratClientParticulier, fetchPDF, fetchRecupereDocumentContractuelListx, fetchVisualiserAccordCommercial, fetchVisualiserCalendrierPaiement, fetchVisualiserHistoConso, fetchVisualiserPartenaire, getEDFToken, getEdelia, getF, localization, logger, moment, parser, prepareEntries, request, saveMissingBills, translate, updateOrCreate, xml2js,
=======
...
fetchListerContratClientParticulier = function(reqFields, entries, data, callback) {
  ...
  return edfRequestPost(path, body, function(err, result) {
<<<<<<< HEAD
    var addressObject, bpObject, civilite, client, coHolder, coTitulaireElem, codePostal, contracts, contratElems, e, error1, identiteObj, nom, nomRue, numRue, prenom, resBody, ville;
=======
...
fetchVisualiserPartenaire = function(requiredFields, entries, data, callback) {
  ...
  return edfRequestPost(path, body, function(err, result) {
<<<<<<< HEAD
    var address, addressElem, client, contact, contactElem, coordonneesElem, e, error1, partnerElem;
=======
...
fetchVisualiserAccordCommercial = function(requiredFields, entries, data, callback) {
  ...
  return edfRequestPost(path, body, function(err, result) {
<<<<<<< HEAD
    var acoElem, bankAddress, bankDetails, e, error1, paymentTerms, services, servicesElem;
=======
...
fetchVisualiserCalendrierPaiement = function(requiredFields, entries, data, callback) {
  ...
  return edfRequestPost(path, body, function(err, result) {
<<<<<<< HEAD
    var e, error1, listeEcheances, paymentSchedules;
=======
...
<<<<<<< HEAD
    var e, error, error1, ref, statements;
=======
...
saveMissingBills = function(requiredFields, entries, data, callback) {
  return EDFBill.all(function(err, bills) {
...
<<<<<<< HEAD
  ...
  fetchOperations: [prepareEntries, getEDFToken, fetchListerContratClientParticulier, fetchVisualiserPartenaire, fetchVisualiserAccordCommercial, fetchVisualiserCalendrierPaiement, fetchRecupereDocumentContractuelListx, fetchVisualiserHistoConso, updateOrCreate(logger, EDFClient, ['clientId', 'vendor']), updateOrCreate(logger, EDFContract, ['number', 'vendor']), updateOrCreate(logger, EDFPaymentTerms, ['vendor', 'clientId']), updateOrCreate(logger, EDFHome, ['pdl']), updateOrCreate(logger, EDFConsumptionStatement, ['contractNumber', 'statementType', 'statementReason', 'statementCategory', 'start']), updateOrCreate(logger, EDFBill, ['vendor', 'number']), saveMissingBills, buildNotifContent]
=======
  dataType: ['bill', 'contract', 'consumption'],
  models: [EDFClient, EDFContract, EDFPaymentTerms, EDFHome, EDFConsumptionStatement, EDFBill],
  fetchOperations: [prepareEntries, getEDFToken, fetchListerContratClientParticulier, fetchVisualiserPartenaire, fetchVisualiserAccordCommercial, fetchVisualiserCalendrierPaiement, fetchRecupereDocumentContractuelListx, fetchVisualiserHistoConso, fetchEdeliaData, updateOrCreate(logger, EDFClient, ['clientId', 'vendor']), updateOrCreate(logger, EDFContract, ['number', 'vendor']), updateOrCreate(logger, EDFPaymentTerms, ['vendor', 'clientId']), updateOrCreate(logger, EDFHome, ['pdl']), updateOrCreate(logger, EDFConsumptionStatement, ['contractNumber', 'statementType', 'statementReason', 'statementCategory', 'start']), updateOrCreate(logger, EDFBill, ['vendor', 'number']), saveMissingBills, buildNotifContent]
>>>>>>> c198a158ff5a25d0a6a270670086d5d2002f5ca3
});
...
getF = function() {
<<<<<<< HEAD
  var e, error1, field, fields, i, len, node;
=======
